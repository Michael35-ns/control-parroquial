<div class="mb-8">
    ...
    @forelse($espaciosConItems as $espacio)
    <div class="flex">
        <h3 class="text-xl font-semibold text-gray-600 mb-2">{{$espacio->nombre}}</h3>
        <div class="px-4 py-1 mb-4">
            <a href="{{route('inventario.pdf', $espacio->id)}}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6 mb-6">
        ...
        @empty
        <p class="text-center bg-red-300 rounded-2xl border p-2 hover:bg-red-400">No hay bienes en este espacio</p>
        @endforelse
    </div>
    @empty
    <p class="text-center bg-red-300 rounded-2xl border p-2 hover:bg-red-400">No hay espacios registrados</p>
    @endforelse
</div>